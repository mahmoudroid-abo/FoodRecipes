package com.maboe.foodrecipes.repositories;
...
import com.maboe.foodrecipes.requests.RecipeApiClient;
...
public class RecipeRepository {
    ...
    private final MediatorLiveData<List<Recipe>> mRecipes = new MediatorLiveData<>();
